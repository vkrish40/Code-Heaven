class Solution {
    public int maxProfit(int k, int[] prices) {
        ...
        /*Cubic time complexity - O(days squared times transactions), passes 209/211 test cases on leetcode 
	before running into memory limit exceeded*/
...
class Solution {
    public int maxProfit(int k, int[] prices) {
        ...
        /*Squared time complexity - O(days times transactions)* but still runs into memory limit exceeded
	 error on the leetcode and manages to pass 209/211 test cases*/
